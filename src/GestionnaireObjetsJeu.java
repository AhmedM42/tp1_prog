...
public class GestionnaireObjetsJeu {
    ...
    private final List<ObjetJeu> objetsJeu = new ArrayList<>();
     ...
     */
    public List<ObjetJeu> trouverObjetsJeu(Etiquette etiquette) {
        List<ObjetJeu> objetsTrouves = new ArrayList<>();
    ...
    /**
     * Trouve et retourne le premier objet de jeu correspondant à l'étiquette spécifiée.
     *
     * @param etiquette Étiquette
     * @return Le projet objet de jeu correspondant si trouvé, null sinon
     */
    public ObjetJeu trouverObjetJeu(Etiquette etiquette) {
        for (ObjetJeu objetJeu : objetsJeu) {
            if (objetJeu.etiquette != null && objetJeu.etiquette == etiquette) {
                return objetJeu;
            }
        }
